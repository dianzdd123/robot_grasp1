...
#ifndef VISION_AI_INTERFACES__SRV__DETAIL__PLAN_SCAN__FUNCTIONS_H_
#define VISION_AI_INTERFACES__SRV__DETAIL__PLAN_SCAN__FUNCTIONS_H_
...
/// Initialize srv/PlanScan message.
/**
...
/// Create srv/PlanScan message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * vision_ai_interfaces__srv__PlanScan_Request__init().
...
/// Destroy srv/PlanScan message.
/**
 * It calls
 * vision_ai_interfaces__srv__PlanScan_Request__fini()
...
/// Check for srv/PlanScan message equality.
/**
...
/// Initialize array of srv/PlanScan messages.
/**
...
/// Finalize array of srv/PlanScan messages.
/**
 * It calls
 * vision_ai_interfaces__srv__PlanScan_Request__fini()
...
/// Create array of srv/PlanScan messages.
/**
 * It allocates the memory for the array and calls
 * vision_ai_interfaces__srv__PlanScan_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/PlanScan messages.
/**
 * It calls
 * vision_ai_interfaces__srv__PlanScan_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/PlanScan message array equality.
/**
...
/// Copy an array of srv/PlanScan messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * vision_ai_interfaces__srv__PlanScan_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_vision_ai_interfaces
...
/**
 * It calls
 * vision_ai_interfaces__srv__PlanScan_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_vision_ai_interfaces
...
/**
 * It allocates the memory for the array and calls
 * vision_ai_interfaces__srv__PlanScan_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_vision_ai_interfaces
...
/**
 * It calls
 * vision_ai_interfaces__srv__PlanScan_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // VISION_AI_INTERFACES__SRV__DETAIL__PLAN_SCAN__FUNCTIONS_H_
