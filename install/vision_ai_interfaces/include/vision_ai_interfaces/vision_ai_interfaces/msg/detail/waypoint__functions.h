...
#ifndef VISION_AI_INTERFACES__MSG__DETAIL__WAYPOINT__FUNCTIONS_H_
#define VISION_AI_INTERFACES__MSG__DETAIL__WAYPOINT__FUNCTIONS_H_
 ...
 * calls
 * vision_ai_interfaces__msg__Waypoint__init().
...
/**
 * It calls
 * vision_ai_interfaces__msg__Waypoint__fini()
 ...
 * vision_ai_interfaces__msg__Waypoint__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * vision_ai_interfaces__msg__Waypoint__Sequence__fini()
 * on the array,
...
#endif  // VISION_AI_INTERFACES__MSG__DETAIL__WAYPOINT__FUNCTIONS_H_
