...
#include "vision_ai_interfaces/msg/detail/detected_object__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const vision_ai_interfaces::msg::DetectedObject & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vision_ai_interfaces::msg::DetectedObject & ros_message)
{
  // Member: object_id
  cdr >> ros_message.object_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vision_ai_interfaces::msg::DetectedObject;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vision_ai_interfaces::msg::DetectedObject *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vision_ai_interfaces::msg::DetectedObject *>(
    untyped_ros_message);
...
get_message_type_support_handle<vision_ai_interfaces::msg::DetectedObject>()
{
  return &vision_ai_interfaces::msg::typesupport_fastrtps_cpp::_DetectedObject__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vision_ai_interfaces, msg, DetectedObject)() {
  return &vision_ai_interfaces::msg::typesupport_fastrtps_cpp::_DetectedObject__handle;
}
