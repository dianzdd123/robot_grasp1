...
#include "vision_ai_interfaces/msg/detail/waypoint__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const vision_ai_interfaces::msg::Waypoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vision_ai_interfaces::msg::Waypoint & ros_message)
{
  // Member: pose
  ...
  // Member: coverage_rect
  {
    ...
    ros_message.coverage_rect.resize(size);
    for (size_t i = 0; i < size; i++) {
      geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.coverage_rect[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: coverage_rect
  {
    size_t array_size = ros_message.coverage_rect.size();
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        geometry_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.coverage_rect[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vision_ai_interfaces::msg::Waypoint;
    is_plain =
      (
      offsetof(DataType, coverage_rect) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const vision_ai_interfaces::msg::Waypoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vision_ai_interfaces::msg::Waypoint *>(
    untyped_ros_message);
...
get_message_type_support_handle<vision_ai_interfaces::msg::Waypoint>()
{
  return &vision_ai_interfaces::msg::typesupport_fastrtps_cpp::_Waypoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vision_ai_interfaces, msg, Waypoint)() {
  return &vision_ai_interfaces::msg::typesupport_fastrtps_cpp::_Waypoint__handle;
}
