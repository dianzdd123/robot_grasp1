...
#include "vision_ai_interfaces/msg/detail/detection_result__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const vision_ai_interfaces::msg::DetectedObject &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const vision_ai_interfaces::msg::DetectionResult & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vision_ai_interfaces::msg::DetectionResult & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        vision_ai_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_DetectedObject(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = vision_ai_interfaces::msg::DetectionResult;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vision_ai_interfaces::msg::DetectionResult *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vision_ai_interfaces::msg::DetectionResult *>(
    untyped_ros_message);
...
{
  return &vision_ai_interfaces::msg::typesupport_fastrtps_cpp::_DetectionResult__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vision_ai_interfaces, msg, DetectionResult)() {
  return &vision_ai_interfaces::msg::typesupport_fastrtps_cpp::_DetectionResult__handle;
}
