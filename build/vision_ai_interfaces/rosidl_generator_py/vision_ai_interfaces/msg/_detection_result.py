...
class Metaclass_DetectionResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from vision_ai_interfaces.msg import DetectedObject
...
class DetectionResult(metaclass=Metaclass_DetectionResult):
    ...
    _fields_and_field_types = {
        ...
        'objects': 'sequence<vision_ai_interfaces/DetectedObject>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['vision_ai_interfaces', 'msg'], 'DetectedObject')),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        self.detection_count = kwargs.get('detection_count', int())
    ...
    def __eq__(self, other):
        ...
        if self.header != other.header:
            return False
        if self.detection_count != other.detection_count:
            return False
    ...
    def detection_count(self):
        """Message field 'detection_count'."""
        return self._detection_count

    @detection_count.setter
    def detection_count(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'detection_count' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'detection_count' field must be an integer in [-2147483648, 2147483647]"
    ...
    def processing_time(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'processing_time' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
