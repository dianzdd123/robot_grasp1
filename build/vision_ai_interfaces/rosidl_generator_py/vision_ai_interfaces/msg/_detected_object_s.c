...
bool vision_ai_interfaces__msg__detected_object__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vision_ai_interfaces.msg._detected_object.DetectedObject", full_classname_dest, 56) == 0);
  }
  vision_ai_interfaces__msg__DetectedObject * ros_message = _ros_message;
  {  // object_id
  ...
  {  // bounding_box
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      float * dest = ros_message->bounding_box.data;
...
PyObject * vision_ai_interfaces__msg__detected_object__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("vision_ai_interfaces.msg._detected_object");
  ...
  {  // bounding_box
    ...
    if (ros_message->bounding_box.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      float * src = &(ros_message->bounding_box.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->bounding_box.size * sizeof(float));
      assert(data != NULL);
