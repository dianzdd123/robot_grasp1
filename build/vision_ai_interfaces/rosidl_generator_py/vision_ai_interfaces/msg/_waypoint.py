...
class Waypoint(metaclass=Metaclass_Waypoint):
    ...
    _fields_and_field_types = {
        ...
        'coverage_rect': 'sequence<geometry_msgs/Point>',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.coverage_rect = kwargs.get('coverage_rect', [])
    ...
    def __eq__(self, other):
        ...
        if self.waypoint_index != other.waypoint_index:
            return False
        if self.coverage_rect != other.coverage_rect:
            return False
        return True
    ...
    @builtins.property
    def coverage_rect(self):
        """Message field 'coverage_rect'."""
        return self._coverage_rect

    @coverage_rect.setter
    def coverage_rect(self, value):
        if __debug__:
            from geometry_msgs.msg import Point
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'coverage_rect' field must be a set or sequence and each value of type 'Point'"
        self._coverage_rect = value
