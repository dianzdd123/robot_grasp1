...
class Metaclass_ImageData(type):
    """Metaclass of message 'ImageData'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__image_data
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__image_data
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__image_data
            cls._TYPE_SUPPORT = module.type_support_msg__msg__image_data
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__image_data
...
class ImageData(metaclass=Metaclass_ImageData):
    ...
    _fields_and_field_types = {
        ...
        'waypoint': 'vision_ai_interfaces/Waypoint',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['vision_ai_interfaces', 'msg'], 'Waypoint'),  # noqa: E501
