...
#include "vision_ai_interfaces/msg/detail/waypoint__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/point__functions.h"  // coverage_rect
...
using _Waypoint__ros_msg_type = vision_ai_interfaces__msg__Waypoint;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: coverage_rect
  {
    ...
    auto array_ptr = ros_message->coverage_rect.data;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: coverage_rect
  {
    ...
    if (ros_message->coverage_rect.data) {
      geometry_msgs__msg__Point__Sequence__fini(&ros_message->coverage_rect);
    }
    if (!geometry_msgs__msg__Point__Sequence__init(&ros_message->coverage_rect, size)) {
      fprintf(stderr, "failed to create array for field 'coverage_rect'");
      return false;
    }
    auto array_ptr = ros_message->coverage_rect.data;
    for (size_t i = 0; i < size; ++i) {
...
static uint32_t _Waypoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vision_ai_interfaces__msg__Waypoint(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vision_ai_interfaces__msg__Waypoint;
    is_plain =
      (
...
static size_t _Waypoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vision_ai_interfaces__msg__Waypoint(
