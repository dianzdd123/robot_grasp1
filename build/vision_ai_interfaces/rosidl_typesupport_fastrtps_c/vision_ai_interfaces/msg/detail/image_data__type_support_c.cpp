...
#include "vision_ai_interfaces/msg/detail/image_data__rosidl_typesupport_fastrtps_c.h"
...
#include "vision_ai_interfaces/msg/detail/waypoint__functions.h"  // waypoint
...
using _ImageData__ros_msg_type = vision_ai_interfaces__msg__ImageData;

static bool _ImageData__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ImageData__ros_msg_type * ros_message = static_cast<const _ImageData__ros_msg_type *>(untyped_ros_message);
  // Field name: filename
  {
...
static bool _ImageData__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _ImageData__ros_msg_type * ros_message = static_cast<_ImageData__ros_msg_type *>(untyped_ros_message);
  // Field name: filename
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _ImageData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vision_ai_interfaces__msg__ImageData(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vision_ai_interfaces__msg__ImageData;
    is_plain =
      (
...
static size_t _ImageData__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_vision_ai_interfaces__msg__ImageData(
...
static message_type_support_callbacks_t __callbacks_ImageData = {
  "vision_ai_interfaces::msg",
  "ImageData",
  _ImageData__cdr_serialize,
  _ImageData__cdr_deserialize,
  _ImageData__get_serialized_size,
  _ImageData__max_serialized_size
};

static rosidl_message_type_support_t _ImageData__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ImageData,
