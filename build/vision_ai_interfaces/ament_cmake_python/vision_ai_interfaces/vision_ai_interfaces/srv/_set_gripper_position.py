...
class Metaclass_SetGripperPosition(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'vision_ai_interfaces.srv.SetGripperPosition')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from vision_ai_interfaces.srv import _set_gripper_position
...
class SetGripperPosition(metaclass=Metaclass_SetGripperPosition):
    from vision_ai_interfaces.srv._set_gripper_position import SetGripperPosition_Request as Request
    from vision_ai_interfaces.srv._set_gripper_position import SetGripperPosition_Response as Response
