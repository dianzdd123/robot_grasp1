...
static const _ImageData_type_support_symbol_names_t _ImageData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vision_ai_interfaces, msg, ImageData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vision_ai_interfaces, msg, ImageData)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, vision_ai_interfaces, msg, ImageData)() {
  return &::vision_ai_interfaces::msg::rosidl_typesupport_c::ImageData_message_type_support_handle;
}
